...
class PredictModel:
    ...
    def batch_predict_from_model(self):
        try:
            ...
            clusters = kmeans.predict(self.X.drop(['transaction_id', 'user_id', 'fecha', 'dispositivo', 'dcto', 'cashback'],axis=1))
            ...
            for i in clusters:
                ...
                cluster_data_new = cluster_data.drop(['transaction_id', 'user_id', 'fecha', 'dispositivo', 'dcto', 'cashback','clusters'], axis=1)
